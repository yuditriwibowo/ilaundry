  ...
  return (
    <div className="flex h-full w-full flex-col -mt-2">
      <div className="sticky top-0 z-10 md:static md:bg-gray-50">
        ...
        <div className="bg-gradient-to-r from-blue-700 via-blue-600 to-indigo-700 shadow-md pb-3 px-4 pt-6 -mx-4 rounded-b-xl md:bg-none md:shadow-none md:pb-0 md:px-0 md:pt-0 md:mx-0 md:rounded-b-none short-screen:pb-2 short-screen:pt-3">
