...
import Table from "@/app/ui/pesanan_old/table";
import { CreatePesanan } from "@/app/ui/pesanan_old/buttons";
  ...
  return (
    <div className="flex h-full w-full flex-col -mt-2">
      ...
      <div className="flex-1 overflow-y-auto scrollbar-hide min-h-0">
        ...
        <div className="mt-5 flex w-full justify-center short-screen:mt-3">
