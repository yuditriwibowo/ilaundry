 ...
 *   /laundry/analisa/layanan?mulai=..&sampai=..
 */
...
export default function AnalisaLayananMenuLink({
  title = "Analisa Layanan",
  description = "Analisa data layanan",
}: {
  // Ikon (Shirt) diimpor langsung di file client ini — komponen ikon adalah
    ...
    <>
      ...
      <PilihPeriodePopup
        ...
        onSubmitAction={({ mulai, sampai }) => {
          setOpen(false);
          router.push(
            `/laundry/analisa/layanan?mulai=${mulai}&sampai=${sampai}`,
          );
        }}
      />
    </>
