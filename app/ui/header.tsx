...
export default function Header() {
  ...
  return (
    <header className={`flex-none ${showGapOnMobile ? "pt-3" : "pt-0 md:pt-3"} px-4 pb-4 z-50 flex justify-center ${!showOnMobile ? "hidden md:flex" : ""} bg-gradient-to-br from-primary-400 to-primary-800 rounded-b-xl mb-4`}>
      <Link
