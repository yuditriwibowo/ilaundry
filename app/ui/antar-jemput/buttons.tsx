...
export function CreateAntarJemput() {
  return (
    <Link
      href="/laundry/pengaturan/antar-jemput/create"
    ...
    >
      <span className="hidden md:block">Tambah Antar-Jemput</span>{" "}
  ...
  return (
    <>
      <button
        type="button"
        onClick={(e) => {
          // stopPropagation di tombol itu sendiri (bukan hanya di wrapper parent)
          // agar tap pada tombol tidak pernah bisa memicu onClick ancestor yang
          // bisa diklik (mis. navigasi detail pada kartu list di mobile).
          e.stopPropagation();
          setShowConfirm(true);
        }}
        title="Hapus"
