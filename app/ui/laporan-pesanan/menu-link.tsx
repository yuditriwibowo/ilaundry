 ...
 *   /laundry/laporan/pesanan?mulai=..&sampai=..
 */
...
export default function LaporanPesananMenuLink({
  title = "Laporan Pesanan",
  description = "Laporan data pesanan",
}: {
  // Ikon (ReceiptText) diimpor langsung di file client ini — komponen
    ...
    <>
      ...
      <PilihPeriodePopup
        ...
        onSubmitAction={({ mulai, sampai }) => {
          setOpen(false);
          router.push(
            `/laundry/laporan/pesanan?mulai=${mulai}&sampai=${sampai}`,
          );
        }}
      />
    </>
