      ...
      <div className="sticky top-0 z-10 bg-gradient-to-b from-primary-400 to-primary-800 pb-6 px-4 pt-6 -mx-4 rounded-b-xl md:static md:bg-none md:bg-gray-50 md:pb-0 md:px-0 md:pt-0 md:mx-0 md:rounded-b-none">
        <div className="flex flex-col md:flex-row w-full items-start md:items-center gap-4 md:gap-0">
          <div className="block landscape:hidden md:hidden w-full">
            <div className={`${shimmer} relative overflow-hidden h-12 w-full bg-gray-200 rounded-lg`} />
          </div>
          <div className="w-full flex items-center gap-4 justify-between">
            <div className={`${shimmer} relative overflow-hidden h-10 w-full max-w-xs rounded-md bg-gray-200`} />
...
export function PesananTableRowSkeleton() {
  return (
    <tr className="w-full border-b border-gray-100 py-3 text-sm last-of-type:border-none [&:first-child>td:first-child]:rounded-tl-lg [&:first-child>td:last-child]:rounded-tr-lg [&:last-child>td:first-child]:rounded-bl-lg [&:last-child>td:last-child]:rounded-br-lg">
      <td className="whitespace-nowrap py-3 pl-6 pr-3">
        <div className="h-6 w-32 rounded bg-gray-100"></div>
